<aside style="background:  #a1c0de;;" class="main-sidebar text-white elevation-4">
  <!-- dropdown -->
  <div class="dropdown">
    <a href="javascript:void(0)" class="brand-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
      <span
        ...
        <?php echo strtoupper(substr($_SESSION['login_firstname'], 0, 1)) ?>
      </span>
      <span class="brand-text font-weight-light" style="color: #000000; ">
        <?php echo ucwords($_SESSION['login_firstname'] . ' ' . $_SESSION['login_lastname']) ?>
      </span>

    </a>
    <div class="dropdown-menu" style="background: #a1c0de;;">
